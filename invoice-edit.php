...
if($result) {
	while ($row = mysqli_fetch_assoc($result)) {
        ...
        $custom_email = isset($row['custom_email']) ? $row['custom_email'] : ''; // invoice custom email body
        ...
        $invoice_subtotal = isset($row['subtotal']) ? $row['subtotal'] : ''; // invoice sub-total
        $invoice_shipping = isset($row['shipping']) ? $row['shipping'] : ''; // invoice shipping amount
        $invoice_discount = isset($row['discount']) ? $row['discount'] : ''; // invoice discount
        $invoice_vat = isset($row['vat']) ? $row['vat'] : ''; // invoice vat
        $invoice_total = isset($row['total']) ? $row['total'] : ''; // invoice total
        $invoice_notes = isset($row['notes']) ? $row['notes'] : ''; // Invoice notes
		$invoice_type = isset($row['invoice_type']) ? $row['notes']: ''; // Invoice type
